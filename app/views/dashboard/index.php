<?php $cfg = include __DIR__ . '/../../../config/config.php'; $base = $cfg['app']['base_url']; $usuarios = $cfg['app']['usuario']; ?>
  ...
  <div class="row g-3">
    <div class="col-md-3">
      <div class="card shortcut">
        <div class="card-body">
          <a class="btn btn-outline-primary btn-sm-title"  href="<?= $usuarios ?>">Usuarios</a>
    ...
    <div class="col-md-3">
      <div class="card shortcut">
        <div class="card-body">
          <h5 class="btn btn-outline-primary btn-sm-title">Inventario</h5>
    ...
    <div class="col-md-3">
      <div class="card shortcut">
        <div class="card-body">
          <h5 class="btn btn-outline-primary btn-sm-title">Ventas</h5>
    ...
    <div class="col-md-3">
      <div class="card shortcut">
        <div class="card-body">
          <h5 class="btn btn-outline-primary btn-sm-title">Reportes</h5>
